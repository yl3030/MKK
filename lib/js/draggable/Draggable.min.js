...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine(
    ...
    function (a, b, c) {
      var d,
        ...
        t = function (a) {
          return r.createElementNS
            ? r.createElementNS("http://www.w3.org/1999/xhtml", a)
            : r.createElement(a);
        },
        u = t("div"),
        v = [],
        ...
        O = function (a) {
          C.push(a),
            1 === C.length && b.ticker.addEventListener("tick", N, this, !1, 1);
        },
        P = function (a) {
        ...
        S = function () {
          return null != window.pageYOffset
            ...
            : null != r.scrollTop
            ? r.scrollTop
            : s.scrollTop || r.body.scrollTop || 0;
        },
        T = function () {
          return null != window.pageXOffset
            ...
            : null != r.scrollLeft
            ? r.scrollLeft
            : s.scrollLeft || r.body.scrollLeft || 0;
        },
        U = function (a, b) {
        ...
        X = function (a, b) {
          ...
          return Math.max(
            0,
            W(a)
              ? Math.max(s[d], f[d]) - (window["inner" + c] || s[e] || f[e])
              : a[d] - a[e]
          );
        },
        Y = function (a) {
        ...
        Z = function (a, b) {
          return (
            (a = a || window.event),
            (q.pageX = a.clientX + r.body.scrollLeft + s.scrollLeft),
            (q.pageY = a.clientY + r.body.scrollTop + s.scrollTop),
            b && (a.returnValue = !1),
            q
          );
        },
            ...
            "%" === d && -1 !== b.indexOf("border")
              ...
              : ((i.cssText =
                ...
                "%" !== d && h.appendChild
                  ...
                  : ((h = a.parentNode || r.body),
                    (i[g ? "width" : "height"] = c + d)),
                h.appendChild(u),
                (f = parseFloat(u[g ? "offsetWidth" : "offsetHeight"])),
                h.removeChild(u),
                0 !== f || e || (f = ea(a, b, c, d, !0))),
            j ? -f : f
          );
        },
        fa = function (a, b) {
          ...
          return (
            a["offset" + c] -
            (ea(a, b, parseFloat(d), (d + "").replace(da, "")) || 0)
          );
        },
        ga = function (a, b, c) {
          var d,
        ...
        ja = function () {
          ...
          r.body &&
            ma &&
            ((l.position = k.style.position = "absolute"),
            m.appendChild(k),
            k.appendChild(e),
            (l.height = "10px"),
            (d = e.offsetTop),
        ...
        va = function (a) {
          ...
          if (
            Ra.cacheSVGData !== !1 &&
            a._gsCache &&
            a._gsCache.lastUpdate === b.ticker.frame
          )
            return a._gsCache;
          var c,
            d,
          ...
          if (((u.lastUpdate = b.ticker.frame), a.getBBox && !u.isSVGRoot)) {
            ...
            return (
              (f = va(t)),
              (u.offsetTop = c.y * f.scaleY),
              (u.offsetLeft = c.x * f.scaleX),
              (u.scaleX = f.scaleX),
              (u.scaleY = f.scaleY),
              (u.offsetParent = t || s),
              u
          ...
          for (
            e = u.offsetParent,
              e === r.body && (e = s),
              ua.length = ta.length = 0;
            t &&
            ((j = ga(t, ma, !0)),
            "matrix(1, 0, 0, 1, 0, 0)" !== j &&
              "none" !== j &&
              "translate3d(0px, 0px, 0px)" !== j &&
              (ua.push(t), ta.push(t.style[ma]), (t.style[ma] = "none")),
            t !== e);
            ...
            d = e.getBoundingClientRect(),
              ...
              i
                ? ((c = a.getBoundingClientRect()),
                  (u.offsetLeft = c.left - d.left),
                  (u.offsetTop = c.top - d.top))
                : ((u.offsetLeft = l.x - d.left), (u.offsetTop = l.y - d.top)),
              u.offsetParent = e,
              k = ua.length;
            --k > -1;
        ...
        xa = function (a) {
          ...
          if (
            ...
            (d.offsetParent = a.offsetParent) ||
              ((c = a.parentNode || s),
              c.insertBefore(u, a),
              (d.offsetParent = u.offsetParent || s),
              c.removeChild(u));
          else if (f) {
            for (
              c = a.parentNode;
        ...
        ya = function (a, b, c, d) {
          ...
          return (
            (e =
              w.isSVG && -1 !== (a.style[ma] + "").indexOf("matrix")
                ? a.style[ma]
                : z
                ? z.getPropertyValue(na)
                : a.currentStyle
                ? a.currentStyle[ma]
                : "1,0,0,1,0,0"),
            a.getBBox &&
            ...
            d
              ...
              : w.isSVG &&
                ...
                (e[4] =
                  parseFloat(e[4]) -
                  (k.xOrigin - (k.xOrigin * e[0] + k.yOrigin * e[2]))),
                (e[5] =
                  parseFloat(e[5]) -
                  (k.yOrigin - (k.xOrigin * e[1] + k.yOrigin * e[3])))),
            b &&
              (void 0 === g && ja(),
              (h = w.isSVG || w.isSVGRoot ? va(a) : a),
              w.isSVG
                ? ((i = a.getBBox()),
                  (p = y.isSVGRoot ? { x: 0, y: 0 } : x.getBBox()),
                  (h = {
                    offsetLeft: i.x - p.x,
                    offsetTop: i.y - p.y,
                ...
                : w.isSVGRoot
                ? ((q = parseInt(z.borderTopWidth, 10) || 0),
                  (t = parseInt(z.borderLeftWidth, 10) || 0),
                  (u = (e[0] - g) * t + e[2] * q),
                  (v = e[1] * t + (e[3] - g) * q),
                  (l = b.x),
                  (m = b.y),
                  (n = l - (l * e[0] + m * e[2])),
                  (o = m - (l * e[1] + m * e[3])),
                  (e[4] = parseFloat(e[4]) + n),
                  (e[5] = parseFloat(e[5]) + o),
                  (b.x -= n),
                  (b.y -= o),
                  (l = h.scaleX),
                  (m = h.scaleY),
                ...
                : !j &&
                  a.offsetParent &&
                  ((b.x +=
                    parseInt(ga(a.offsetParent, "borderLeftWidth"), 10) || 0),
                  (b.y +=
                    parseInt(ga(a.offsetParent, "borderTopWidth"), 10) || 0)),
              (f = x === s || x === r.body),
              (e[4] =
                Number(e[4]) +
                b.x +
              ...
              x &&
                ...
                j ||
                  ...
                  w.isSVGRoot ||
                  ((e[4] -=
                    parseInt(ga(x.offsetParent, "borderLeftWidth"), 10) || 0),
                  (e[5] -=
                    parseInt(ga(x.offsetParent, "borderTopWidth"), 10) || 0)))),
            e
          );
        },
        za = function (a, b) {
          ...
          for (
            var c,
              ...
              m = ya(a, k, l);
            (a = a.parentNode) && a.parentNode && a !== s;

          )
            (k = l),
              (l = wa(a.parentNode, k === oa ? pa : oa)),
              (i = ya(a, k, l)),
              (c = m[0]),
              (d = m[1]),
              (e = m[2]),
        ...
        Ca = function (a, b, c) {
          ...
          if (a === window)
            (g = S()),
              (e = T()),
              (f =
                e + (s.clientWidth || a.innerWidth || r.body.clientWidth || 0)),
              (h =
                g +
                ((a.innerHeight || 0) - 20 < s.clientHeight
                  ? s.clientHeight
                  : a.innerHeight || r.body.clientHeight || 0));
          else {
            ...
            (d = wa(a)),
              ...
              "svg" !== a.nodeName.toLowerCase() ||
                ...
                (x = parseFloat(w[0])),
                (y = parseFloat(w[1])),
                (u = parseFloat(B.borderLeftWidth) || 0),
                (v = parseFloat(B.borderTopWidth) || 0),
                (f -= p - (p - u) / t.scaleX - x),
                (h -= q - (q - v) / t.scaleY - y),
                (e -= u / t.scaleX - x),
                (g -= v / t.scaleY - y),
                z &&
                  ((f += (parseFloat(B.borderRightWidth) + u) / t.scaleX),
        ...
        Ga = (function (a) {
          for (
            var b = a.split(","),
              c = (
                void 0 !== u.onpointerdown
                  ? "pointerdown,pointermove,pointerup,pointercancel"
                  : void 0 !== u.onmspointerdown
        ...
        Ha = function (a, b, c, d) {
          a.addEventListener
            ? a.addEventListener(Ga[b] || b, c, d)
            : a.attachEvent && a.attachEvent("on" + b, c);
        },
        Ia = function (a, b, c) {
          a.removeEventListener
            ? a.removeEventListener(Ga[b] || b, c)
        ...
        Oa = function (a, b) {
          for (var c, d = a.length; --d > -1; )
            (c = a[d]),
              (c.ondragstart = c.onselectstart = b ? null : w),
        ...
        Pa = (function () {
          ...
          return (
            ...
            b.appendChild(c),
            e.appendChild(b),
            (k = c.offsetHeight + 18 > b.scrollHeight),
            (d.width = "100%"),
            ma ||
                  ...
                  (o || g) &&
                    (h
                      ? this._suspendTransforms ||
                        (l[ma] = h + -o + "px," + -n + i)
                      : (l.left = -o + "px"),
                    Pa && o + u >= 0 && (l.paddingRight = o + u + "px")),
                  (a.scrollLeft = 0 | d),
                  void (q = a.scrollLeft));
            }),
            ...
            (this.calibrate = function (b) {
              ...
              (p = a.scrollTop),
                ...
                (!h ||
                  ...
                  (l.width = "100%"),
                  (l.paddingRight = u + "px"),
                  k && (l.paddingBottom = ga(a, "paddingBottom", !0)),
                  A && (l.zoom = "1"),
                  (d = a.clientWidth),
                  (e = a.clientHeight),
                  (s = a.scrollWidth),
          ...
          var h,
                ...
                for (
                  Ta = !1,
                    ...
                    K.scrollLeft =
                      null != window.pageXOffset
                        ...
                        ? s.scrollLeft
                        : r.body.scrollLeft,
                    f = Ea.pointerX - K.scrollLeft,
                    g = Ea.pointerY - K.scrollTop;
                  l && !c;
                  ...
                  (c = W(l.parentNode)),
                    ...
                    c &&
                      ...
                      gb(Ea.pointerX + h, Ea.pointerY + j)),
                    (l = b);
              }
              if (ba) {
                var n = Ea.x,
                ...
                p > n && n > -p && (n = 0),
                  p > o && o > -p && (o = 0),
                  wa
                    ? ((pa.data.rotation = Ea.rotation = n), pa.setRatio(1))
                    : i
                    ? (Ca && i.top(o), Ba && i.left(n))
                    : va
                    ? (Ca && (pa.data.y = o),
                      Ba && (pa.data.x = n),
                      pa.setRatio(1))
                    : (Ca && (d.style.top = o + "px"),
                      Ba && (d.style.left = n + "px")),
                  !w ||
                    a ||
                    sa ||
                    ((sa = !0), ha(Ea, "drag", "onDrag"), (sa = !1));
              }
              ba = !1;
            },
            Xa = function (a, c) {
              ...
              d._gsTransform ||
                ...
                va
                  ? ((Ea.y = d._gsTransform.y), (Ea.x = d._gsTransform.x))
                  : wa
                  ? (Ea.x = Ea.rotation = d._gsTransform.rotation)
                  : i
                  ? ((Ea.y = i.top()), (Ea.x = i.left()))
                  : ((Ea.y = parseInt(d.style.top, 10) || 0),
                    (Ea.x = parseInt(d.style.left, 10) || 0)),
                (!da && !ea) ||
                  c ||
                  (da &&
                    ((e = da(Ea.x)),
                    e !== Ea.x && ((Ea.x = e), wa && (Ea.rotation = e))),
                  ea && ((e = ea(Ea.y)), e !== Ea.y && (Ea.y = e))),
                (f !== Ea.x || g !== Ea.y) && Wa(!0),
            ...
            Ya = function () {
              ...
              (u = !1),
                i
                  ? (i.calibrate(),
                    (Ea.minX = F = -i.maxScrollLeft()),
                    (Ea.minY = N = -i.maxScrollTop()),
                    (Ea.maxX = C = Ea.maxY = J = 0),
                    (u = !0))
                  : g.bounds &&
                    ((a = ia(g.bounds, d.parentNode)),
                    wa
                      ? ((Ea.minX = F = a.left),
                        (Ea.maxX = C = a.left + a.width),
                        (Ea.minY = N = Ea.maxY = J = 0))
                      ...
                      ? ((a = g.bounds),
                        ...
                        (Ea.maxY = J = a.maxY))
                      : ((b = ia(d, d.parentNode)),
                        (Ea.minX = F = ga(d, xa) + a.left - b.left),
                        (Ea.minY = N = ga(d, ya) + a.top - b.top),
                        (Ea.maxX = C = F + (a.width - b.width)),
                        (Ea.maxY = J = N + (a.height - b.height))),
                    F > C && ((Ea.minX = C), (Ea.maxX = C = F), (F = Ea.minX)),
                    N > J && ((Ea.minY = J), (Ea.maxY = J = N), (N = Ea.minY)),
                    wa && ((Ea.minRotation = F), (Ea.maxRotation = C)),
                    (u = !0)),
                g.liveSnap &&
                  ((c = g.liveSnap === !0 ? g.snap || {} : g.liveSnap),
                  (e = c instanceof Array || "function" == typeof c),
                  wa
                    ? ((da = db(e ? c : c.rotation, F, C, 1)), (ea = null))
                    : (Ba &&
                        (da = db(
            ...
            _a = function (a, b) {
              ...
              a && f
                ? (a === !0 &&
                    ...
                    wa
                      ? (a.rotation = Ma(Ea, e ? c : c.rotation, C, F, 1, b))
                      : (Ba &&
                          (a[xa] = Ma(
                            Ea,
                            e ? c : c.x || c.left || c.scrollLeft,
                    ...
                    f.to(
                      i || d,
                      {
                        ...
                        onUpdateParams: g.fastMode
                          ? [Ea, "onthrowupdate", "onThrowUpdate"]
                          : v,
                      },
            ...
            ab = function () {
              ...
              (ka = za(d.parentNode, !0)),
                Ea.isPressed &&
                  ...
                  (g = m[5]),
                  (h = a * e - b * c),
                  (i = j * (e / h) + k * (-c / h) + (c * g - e * f) / h),
                  (l = j * (-b / h) + k * (a / h) + -(a * g - b * f) / h),
                  (k = i * ka[1] + l * ka[3] + ka[5]),
                  (j = i * ka[0] + l * ka[2] + ka[4])),
                ka[1] ||
                  ka[2] ||
                  1 != ka[0] ||
                  1 != ka[3] ||
            ...
            bb = function () {
              ...
              ab(),
                i
                  ? (Ya(), (t = i.top()), (q = i.left()))
                  : (cb() ? (Xa(!0, !0), Ya()) : Ea.applyBounds(),
                    wa
                      ? ((_ = Aa(d, { x: 0, y: 0 })),
                        Xa(!0, !0),
                        (q = Ea.x),
                        (t = Ea.y = Math.atan2(_.y - k, j - _.x) * x))
                      : ((na = d.parentNode ? d.parentNode.scrollTop || 0 : 0),
                        (oa = d.parentNode ? d.parentNode.scrollLeft || 0 : 0),
                        (t = ga(d, ya)),
                        (q = ga(d, xa)))),
                u &&
                  a &&
                ...
                if (
                  ...
                  Ga[a.type]
                    ? ((ja =
                      ...
                      Ha(ja, "touchend", hb),
                      Ha(ja, "touchmove", fb),
                      Ha(ja, "touchcancel", hb),
                      Ha(r, "touchstart", La))
                    : ((ja = null), Ha(r, "mousemove", fb)),
                  (ra = null),
                  Ha(r, "mouseup", hb),
                  a && a.target && Ha(a.target, "mouseup", hb),
                  (fa = Ua.call(Ea, a.target) && !g.dragClickables))
                )
                  return (
                    Ha(a.target, "change", hb),
                    ha(Ea, "press", "onPress"),
                    void Oa(Ka, !0)
                  );
                if (
                  ((qa =
                    ...
                    Ba === Ca ||
                    i ||
                    Ea.vars.allowNativeTouchScrolling === !1
                      ? !1
                      : Ba
                      ? "y"
                      : "x"),
                  A
                    ? (a = Z(a, !0))
                    : qa ||
                      Ea.allowEventDefault ||
                      (a.preventDefault(),
                      a.preventManipulation && a.preventManipulation()),
                  a.changedTouches
                    ? ((a = T = a.changedTouches[0]), (X = a.identifier))
                    : a.pointerId
                    ? (X = a.pointerId)
                    : (T = X = null),
                  G++,
                  O(Wa),
                  (k = Ea.pointerY = a.pageY),
                  (j = Ea.pointerX = a.pageX),
                  (qa || Ea.autoScroll) && Y(d.parentNode),
                  !Ea.autoScroll ||
                    wa ||
                    i ||
                    !d.parentNode ||
                    ...
                    B.parentNode ||
                    ((B.style.width = d.parentNode.scrollWidth + "px"),
                    d.parentNode.appendChild(B)),
                  bb(),
                  ka &&
                    ((c = j * ka[0] + k * ka[2] + ka[4]),
                    (k = j * ka[1] + k * ka[3] + ka[5]),
                    (j = c)),
                  Ea.tween && Ea.tween.kill(),
                  (Ea.isThrowing = !1),
                  b.killTweensOf(i || d, !0, Pa),
                  i && b.killTweensOf(d, !0, { scrollTo: 1 }),
                  (Ea.tween = Ea.lockedAxis = null),
                  (g.zIndexBoost || (!wa && !i && g.zIndexBoost !== !1)) &&
                    (d.style.zIndex = Ra.zIndex++),
                  (Ea.isPressed = !0),
                  (w = !(!g.onDrag && !Ea._listeners.drag)),
                  !wa)
                )
                  for (e = Ka.length; --e > -1; )
              ...
              if (h && !e && Ea.isPressed && a) {
                ...
                if (A) a = Z(a, !0);
                  ...
                  if (
                    ...
                    (d = a.pageY),
                    ka &&
                      ((f = c * ka[0] + d * ka[2] + ka[4]),
                      (d = c * ka[1] + d * ka[3] + ka[5]),
                      (c = f)),
                    (ra = Math.abs(c - j) > Math.abs(d - k) && Ba ? "x" : "y"),
                    Ea.vars.lockAxisOnTouchScroll !== !1 &&
                      ((Ea.lockedAxis = "x" === ra ? "y" : "x"),
                      "function" == typeof Ea.vars.onLockAxis &&
                        Ea.vars.onLockAxis.call(Ea, g)),
                    H && qa === ra)
                  )
                    return void hb(g);
                  Ea.allowEventDefault ||
            ...
            gb = function (a, b) {
              ...
              (Ea.pointerX = a),
                (Ea.pointerY = b),
                wa
                  ? ((f = Math.atan2(_.y - b, a - _.x) * x),
                    (g = Ea.y - f),
                    (Ea.y = f),
                    g > 180 ? (t -= 360) : -180 > g && (t += 360),
                    (e = q + (t - f) * i))
                  : (ka &&
                      ((h = a * ka[0] + b * ka[2] + ka[4]),
                      (b = a * ka[1] + b * ka[3] + ka[5]),
                      (a = h)),
                    (d = b - k),
                    (c = a - j),
                    Da > d && d > -Da && (d = 0),
                    Da > c && c > -Da && (c = 0),
                    (Ea.lockAxis || Ea.lockedAxis) &&
                      (c || d) &&
                      ((h = Ea.lockedAxis),
                      h ||
                        ((Ea.lockedAxis = h =
                          Ba && Math.abs(c) > Math.abs(d)
                            ? "y"
                            : Ca
                            ? "x"
                            : null),
                        h &&
                          "function" == typeof Ea.vars.onLockAxis &&
                          Ea.vars.onLockAxis.call(Ea, Ea.pointerEvent)),
                      "y" === h ? (d = 0) : "x" === h && (c = 0)),
                    (e = q + c * i),
                    (f = t + d * i)),
                da || ea
                  ...
                  : u &&
                    ...
                    wa ||
                      (f > J
                        ? (f = J + (f - J) * l)
                        : N > f && (f = N + (f - N) * l))),
                wa || ((e = Math.round(e)), (f = Math.round(f))),
                (Ea.x !== e || (Ea.y !== f && !wa)) &&
                  (wa
                    ? (Ea.endRotation = Ea.x = Ea.endX = e)
                    : (Ca && (Ea.y = Ea.endY = f), Ba && (Ea.x = Ea.endX = e)),
                  (ba = !0),
                  !Ea.isDragging &&
                    Ea.isPressed &&
                    ((Ea.isDragging = !0), ha(Ea, "dragstart", "onDragStart")));
            },
            hb = function (a, c) {
              if (
                h &&
                ...
                (!a ||
                  ...
                  c ||
                  !(
                    (a.pointerId && a.pointerId !== X) ||
                    (a.changedTouches && !Ja(a.changedTouches, X))
                  ))
              ) {
                Ea.isPressed = !1;
                var e,
                ...
                if (
                  ...
                  return (
                    a && Ia(a.target, "change", hb),
                    Oa(Ka, !1),
                    ha(Ea, "release", "onRelease"),
                    ha(Ea, "click", "onClick"),
                    void (fa = !1)
                  );
                if ((P(Wa), !wa))
                ...
                if ((l && ((Sa = I = z()), (Ea.isDragging = !1)), G--, a)) {
                  if (
                    (A && (a = Z(a, !1)),
                    (e = a.changedTouches),
                    e && ((a = e[0]), a !== T && a.identifier !== X))
                  ) {
                    for (
                      f = e.length;
                      --f > -1 && (a = e[f]).identifier !== X;
                  ...
                  k && !l
                            ...
                            (j.click
                              ...
                              : r.createEvent &&
                                ...
                                i.initMouseEvent(
                                  ...
                                  window,
                                  1,
                                  Ea.pointerEvent.screenX,
                                  Ea.pointerEvent.screenY,
                                  Ea.pointerX,
                                  Ea.pointerY,
                                  !1,
                                  !1,
                    ...
                    : (_a(g.throwProps),
                      A ||
                        Ea.allowEventDefault ||
                        !k ||
                        (!g.dragClickables && Ua.call(Ea, k.target)) ||
                        !l ||
                        (qa && (!ra || qa !== ra)) ||
                        k.cancelable === !1 ||
                        (k.preventDefault(),
                        k.preventManipulation && k.preventManipulation()),
                      ha(Ea, "release", "onRelease")),
                  l && ha(Ea, "dragend", "onDragEnd"),
                  !0
                );
              }
            },
            ...
            jb = function (a) {
              ...
              return c && ta !== ma
                ...
                : void (
                    ...
                    (a.preventDefault
                      ? (a.preventDefault(),
                        (c || (d && Ea.vars.suppressClickOnDrag !== !1)) &&
                          a.stopImmediatePropagation())
                      : (a.returnValue = !1),
                    a.preventManipulation && a.preventManipulation())
                  );
            };
          (ca = Ra.get(this.target)),
            ca && ca.kill(),
              ...
              var c,
                ...
                j =
                  "velocity" === a && f
                    ...
                    : "element";
              return (
                "element" === j && ((h = Va(Ea.target)), (i = Va(a))),
                (c =
                  "start" === j
                    ? Ea.x - q
                    : "velocity" === j
                    ? f.getVelocity(this.target, xa)
                ...
                : (Xa(!0),
                  ...
                  u &&
                    ...
                    (Ea.x !== b || Ea.y !== c) &&
                      ((d = !0),
                      (Ea.x = Ea.endX = b),
                      wa ? (Ea.endRotation = b) : (Ea.y = Ea.endY = c),
                      (ba = !0),
                      Wa()),
                    Ea.isThrowing &&
                      (d ||
            ...
            (this.update = function (a, b) {
              ...
              return (
                ab(),
                a ? Ea.applyBounds() : (ba && b && Wa(), Xa(!0)),
                Ea.isPressed &&
                  ((Ba && Math.abs(c - Ea.x) > 0.01) ||
                    (Ca && Math.abs(e - Ea.y) > 0.01 && !wa)) &&
                  bb(),
                Ea.autoScroll && (Y(d.parentNode), (Ta = !0), Wa()),
                Ea
              );
            }),
              ...
              if ("soft" !== a) {
                for (j = Ka.length; --j > -1; )
                  (k = Ka[j]),
                    ...
                    Ha(k, "touchstart", eb),
                    Ha(k, "click", jb, !0),
                    wa || aa(k, "cursor", g.cursor || "move"),
                    aa(k, "touchCallout", "none"),
                    aa(
                      k,
                      "touchAction",
                      Ba === Ca || i ? "none" : Ba ? "pan-y" : "pan-x"
                    );
                Oa(Ka, !1);
              }
              return (
                ...
                f &&
                  "soft" !== a &&
                  f.track(i || d, va ? "x,y" : wa ? "rotation" : "top,left"),
                i && i.enable(),
                (d._gsDragID = e = "d" + E++),
                (D[e] = this),
            ...
            (this.disable = function (a) {
              var b,
                ...
                e = Ea.isDragging;
              if (!wa)
                for (b = Ka.length; --b > -1; ) aa(Ka[b], "cursor", null);
              if ("soft" !== a) {
                for (b = Ka.length; --b > -1; )
                  (c = Ka[b]),
                    aa(c, "touchCallout", null),
                    aa(c, "touchAction", null),
                    Ia(c, "mousedown", eb),
                    Ia(c, "touchstart", eb),
                    Ia(c, "click", jb);
                Oa(Ka, !0),
              ...
              return (
                ...
                f &&
                  "soft" !== a &&
                  f.untrack(i || d, va ? "x,y" : wa ? "rotation" : "top,left"),
                i && i.disable(),
                P(Wa),
                (Ea.isDragging = Ea.isPressed = fa = !1),
                e && ha(Ea, "dragend", "onDragEnd"),
                Ea
              );
            }),
            ...
            -1 !== ua.indexOf("scroll") &&
              ...
              (d.style.overflowY = Ca && !Fa ? "auto" : "hidden"),
              (d.style.overflowX = Ba && !Fa ? "auto" : "hidden"),
              (d = i.content)),
            g.force3D !== !1 && b.set(d, { force3D: !0 }),
            wa ? (Pa.rotation = 1) : (Ba && (Pa[xa] = 1), Ca && (Pa[ya] = 1)),
            wa
              ? ((Q = o), (S = Q.css), (Q.overwrite = !1))
              : va &&
                ((Q = Ba && Ca ? l : Ba ? m : n),
                (S = Q.css),
                (Q.overwrite = !1)),
      ...
      (Sa.constructor = Ra),
        (Sa.pointerX = Sa.pointerY = 0),
        (Sa.isDragging = Sa.isPressed = !1),
        (Ra.version = "0.14.3"),
        (Ra.zIndex = 1e3),
        Ha(r, "touchcancel", function () {}),
        Ha(r, "contextmenu", function (a) {
          var b;
        ...
        (Ra.create = function (a, c) {
          "string" == typeof a && (a = b.selector(a));
          for (
            var d = a && 0 !== a.length ? (Da(a) ? Ea(a) : [a]) : [],
              e = d.length;
            --e > -1;
        ...
        Va = function (a, b) {
          if (a === window)
            return (
              (Ta.left = Ta.top = 0),
              (Ta.width = Ta.right =
                s.clientWidth || a.innerWidth || r.body.clientWidth || 0),
              (Ta.height = Ta.bottom =
                (a.innerHeight || 0) - 20 < s.clientHeight
                  ? s.clientHeight
                  : a.innerHeight || r.body.clientHeight || 0),
